...
namespace Calculator
{
    public partial class Form1 : Form
    {
        ...
        {
            if (firstOperand != 0 && lblResult.Text != "0")
            {
                lblPast.Text = firstOperand.ToString();
                equal("");
                firstOperand = double.Parse(lblResult.Text);
            }
            else if (firstOperand != 0 && operationSign != ' ' && lblResult.Text == "0")
                operationSign = a;
            else
                firstOperand = double.Parse(lblResult.Text);
            lblResult.Text = "0";
        ...
        // Конец блока
        // 0
        private void btnNumZero_Click(object sender, EventArgs e) => zeroUp(0);
        // 1
        private void btnNumOne_Click(object sender, EventArgs e) => zeroUp(1);
        // 2
        private void btnNumTwo_Click(object sender, EventArgs e) => zeroUp(2);
        // 3
        private void btnNumThree_Click(object sender, EventArgs e) => zeroUp(3);
        // 4
        private void btnNumFour_Click(object sender, EventArgs e) => zeroUp(4);
        // 5
        private void btnNumFive_Click(object sender, EventArgs e) => zeroUp(5);
        // 6
        private void btnNumSix_Click(object sender, EventArgs e) => zeroUp(6);
        // 7
        private void btnNumSeven_Click(object sender, EventArgs e) => zeroUp(7);
        // 8
        private void btnNumEight_Click(object sender, EventArgs e) => zeroUp(8);
        // 9
        private void btnNumNine_Click(object sender, EventArgs e) => zeroUp(9);
        // преобразование за 0
        ...
        // сложение
        protected void btnPlus_Click(object sender, EventArgs e) => symUp('+');
        // вычитание
        private void btnMinus_Click(object sender, EventArgs e) => symUp('-');
        // умножение
        private void btnMult_Click(object sender, EventArgs e) => symUp('*');
        // деление
        private void btnDiv_Click(object sender, EventArgs e) => symUp('/');
        // точка
        ...
        // вычисление
        protected void btnEquals_Click(object sender, EventArgs e) => equal("");

        // удаление последнего введённой цифры
        private void btnDeleteLast_Click(object sender, EventArgs e) => deleteLast();

        // полная очистка
        private void btnClear_Click(object sender, EventArgs e) => clearLabels("all");
        // очистка "главного" окна
        private void btnClearResult_Click(object sender, EventArgs e) => clearLabels("main");
        ...
        // фокусировка на кнопке равно
        private void btnActivated(object sender, EventArgs e) => btnEquals.Focus();
    }
}
